...
/**
 * TCellWcdmaGx entity. @author MyEclipse Persistence Tools
 */

public class TCellWcdmaGx implements java.io.Serializable {
	...
	/** minimal constructor */
	public TCellWcdmaGx(String cellLac, String cellCi) {
		this.cellLac = cellLac;
		this.cellCi = cellCi;
	}

	/** full constructor */
	public TCellWcdmaGx(String cellLac, String cellCi, String cellx,
